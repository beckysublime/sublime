brokersjs = {
	...
	update: function () {
		...
		checkColor(gameData.currentTask == 'coinsToAlphaBar.start' || gameData.currentTask2 == 'coinsToAlphaBar.start', 'coinsToAlphaClickButton', '#F8FF01', '#FDFF9A')
		checkColor(gameData.currentTask == 'alphaToBetaBar.start' || gameData.currentTask2 == 'alphaToBetaBar.start', 'alphaToBetaClickButton', '#F8FF01', '#FDFF9A')
...
bars.push('coinsToAlpha')
coinsToAlphaBar = {
	where: 'coinsToAlphaBarDiv',
	granularity: function () {
		return gameData.doesHaveCurrencyBroker * (1.5 / gameData.currencyBrokerSpeed) + !gameData.doesHaveCurrencyBroker * 0.015
	},
	direction: 'forward',
	runOnLoad: true,
	start: function () {
...
alphaToBetaBar = {
	...
	start: function () {
		...
		if (gameData.alphaCoins >= price && gameData.alphaToBetaBar == 0) {
