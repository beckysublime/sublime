tasksjs = {
	...
	update: function () {
		...
		checkColor(gameData.simulationTime, 'checkResultsButton', '#DEAD85', '#50514F')
		...
		checkShow(!gameData.silkRobe && gameData.respectMilestone50, 'buyARobe')
		checkShow(!gameData.unlockDiseaseAreaSwamp && gameData.maps > 3, 'unlockDiseaseAreaSwamp')
		checkShow(!gameData.lightRobe && gameData.maps > 4, 'lightRobe')
